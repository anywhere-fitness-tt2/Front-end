    ...
    <form className="editForm" onSubmit={saveEdit}>
      ...
      <label className="formLabel"> Name :
        ...
        <label className="formLabel"> Type :
          ...
          onChange={e=>setWorkoutToEdit({...workoutToEdit, type:e.target.value})}
        ...
        <label className="formLabel"> Time :
          ...
          onChange={e=>setWorkoutToEdit({...workoutToEdit, time:e.target.value})}
        ...
        <label className="formLabel"> Duration :
          ...
          onChange={e=>setWorkoutToEdit({...workoutToEdit, duration:e.target.value})}
        ...
        <label className="formLabel"> Intensity :
          ...
          onChange={e=>setWorkoutToEdit({...workoutToEdit, intensity:e.target.value})}
        ...
        <label className="formLabel"> Location :
          ...
          onChange={e=>setWorkoutToEdit({...workoutToEdit, location:e.target.value})}
        ...
        <label className="formLabel"> Class Limit :
          ...
          onChange={e=>setWorkoutToEdit({...workoutToEdit, maxSize:e.target.value})}
